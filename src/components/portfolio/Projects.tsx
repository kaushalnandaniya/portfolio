...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      tech: ["PostgreSQL", "Python", "Financial APIs"],
      description: "A real-time portfolio management engine designed for dynamic holdings tracking, asset allocation algorithms, and robust financial data processing.",
      github: "https://github.com/kaushalnandaniya/AssetManagement",
      liveUrl: null,
      image: null,
    },
    {
    ...
    {
      title: "Real-Time Trading & Risk Monitoring",
      category: "Backend System",
      tech: ["Java", "MySQL", "Concurrency"],
      description: "A low-latency trading signal system with built-in arbitrage detection. Features complex real-time risk monitoring to ensure safe execution parameters.",
      github: "https://github.com/kaushalnandaniya/RiskManagement",
      liveUrl: null,
      image: null,
    },
  ];
